...
public class GestureDetector extends InputAdapter {
	 ...
	 * flings,
	 * panning or pinch zooming. Each method returns a boolean indicating if the event should be handed to the next
	 * listener (false
	...
	public static interface GestureListener {
		 ...
		 * moving outside
		 * of the tap square. The tap square is a rectangular area around the initial touch position as specified on
		 * construction
