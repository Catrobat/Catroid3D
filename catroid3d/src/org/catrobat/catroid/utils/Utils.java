...
//		final int newWidth = java.lang.Math.round(((float) width) / ((float) height) * newHeight);
//
...
//	}
    ...
    public static double round(double value, int precision) {
        final int scale = (int) java.lang.Math.pow(10, precision);
...
//	}
    ...
    public static int convertDoubleToPluralInteger(double value) {
        double absoluteValue = java.lang.Math.abs(value);
        if (absoluteValue > 2.5) {
            return (int) java.lang.Math.round(absoluteValue);
        } else {
