 ...
 ******************************************************************************/
//this class is based on and contains source code from libgdx scene2d Actor.class
...
abstract public class Action3d implements Pool.Poolable {
    ...
    /** Sets the actor this action is attached to. This also sets the {@link #setTarget(Actor3d) target} actor if it is null. This
     ...
     * executed for some time, eg it may be {@link DelayAction3d delayed}. The actor's state is best queried in the first call to
     * {@link #act(float)}. For a {@link TemporalAction3d}, use TemporalAction#begin(). */
    ...
    /** Sets the actor this action will manipulate. If no target actor is set, {@link #setActor(Actor3d)} will set the target actor
