...
public class RepeatBrick extends FormulaBrick implements LoopBeginBrick {
    ...
    public RepeatBrick(Formula timesToRepeat) {
        this();
        setFormulaWithBrickField(Brick.BrickField.TIMES_TO_REPEAT, timesToRepeat);
    }
    ...
    public View getView(Context context) {
        ...
        if (getFormulaWithBrickField(Brick.BrickField.TIMES_TO_REPEAT).isSingleNumberFormula()) {
            try {
                label.setText(view.getResources().getQuantityString(
                        R.plurals.time_plural,
                        Utils.convertDoubleToPluralInteger(getFormulaWithBrickField(Brick.BrickField.TIMES_TO_REPEAT)
    ...
    public List<ScriptSequenceAction> addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        ...
        Action3d action = sprite.getActionFactory()
                .createRepeatAction(sprite, getFormulaWithBrickField(Brick.BrickField.TIMES_TO_REPEAT), repeatSequence);
