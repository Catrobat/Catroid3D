...
public interface Brick extends Serializable, Cloneable {
    ...
    enum BrickField {
        COLOR, COLOR_CHANGE, BRIGHTNESS, BRIGHTNESS_CHANGE, X_POSITION, Y_POSITION, Z_POSITION, X_POSITION_CHANGE, Y_POSITION_CHANGE, Z_POSITION_CHANGE,
        TRANSPARENCY, TRANSPARENCY_CHANGE, SIZE, SIZE_CHANGE, VOLUME, VOLUME_CHANGE, X_DESTINATION, Y_DESTINATION, Z_DESTINATION, STEPS,
...
//		LEGO_EV3_SPEED, LEGO_EV3_POWER, LEGO_EV3_PERIOD_IN_SECONDS, LEGO_EV3_DEGREES,
        ...
        LIST_ADD_ITEM, LIST_DELETE_ITEM, INSERT_ITEM_INTO_USERLIST_VALUE,
