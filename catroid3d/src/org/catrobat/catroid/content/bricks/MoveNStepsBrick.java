...
public class MoveNStepsBrick extends FormulaBrick {
    ...
    public View getView(Context context) {
        ...
        if (getFormulaWithBrickField(Brick.BrickField.STEPS).isSingleNumberFormula()) {
            try {
                label.setText(view.getResources().getQuantityString(
                        R.plurals.brick_move_n_step_plural,
                        Utils.convertDoubleToPluralInteger(getFormulaWithBrickField(Brick.BrickField.STEPS).interpretDouble(
    ...
    public List<ScriptSequenceAction> addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory()
                .createMoveNStepsAction(sprite, getFormulaWithBrickField(Brick.BrickField.STEPS)));
        return null;
    }
}
