...
public class Sprite implements Cloneable, Nameable, Serializable {
    ...
    public transient Entity ActorEntity;
...
//	public transient PenConfiguration penConfiguration = new PenConfiguration();
    ...
    //default constructor for grouping
    public Sprite() {
    }

    public Sprite(Entity actorEntity) {
...
//	}
    ...
    //todo fix for conditional scripts
    ...
    public void initializeEventThreads(@EventId.EventType int startType) {
        ...
        ActorEntity.fire(new EventWrapper(new EventId(startType), EventWrapper.NO_WAIT));
    }
